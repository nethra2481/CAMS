...
import { registerFaculty } from "@/app/actions/auth";
      ...
      <Card className="w-full max-w-xl z-10 bg-slate-900/80 border-slate-800 backdrop-blur-xl shadow-2xl">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription className="text-slate-400">
            Join the Cyber Achievement Portal as Faculty
          </CardDescription>
        </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  required
                />
                <p className="text-[10px] text-slate-500">Must be an @cb.amrita.edu or @amrita.edu email</p>
              </div>
